...
?>
        <div class='alert alert-info'>
            <strong>Entry deleted. </strong><a href="mastersList"> Masters list</a>
        </div>
<?php
        } else if($test==false) {
?>
        <div class="alert alert-warning">
            <strong>Error deleting entry! </strong><a href="mastersList"> Masters list</a>
        </div>
<?php
        }
    } else {
?>
        <form method="POST" action="masterDeleteResult?id=<?php echo $id; ?>" enctype="multipart/form-data">
