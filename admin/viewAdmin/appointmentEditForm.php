...
?>
        <div class='alert alert-info'>
            <strong>Entry changed. </strong><a href="appointmentsList"> Appointments list</a>
        </div>
<?php
        } else if($test==false) {
?>
        <div class="alert alert-warning">
            <strong>Record modification error! </strong><a href="appointmentsList"> Appointments list</a>
        </div>
<?php
        }
    } else {
?>
        <form method="POST" action="appointmentEditResult?id=<?php echo $id; ?>" enctype="multipart/form-data">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><textarea type="text" name="dateTime" class="form-control" required ><?php echo $detail['dateTime']; ?></textarea></td>
                </tr>
                <tr>
                    <td colspan="2">
