...
<body>
    ...
    <div class="container">
        <form class="form-signin" action="login.php" method="POST">
            ...
            <input type="text" name="email" class="form-control" placeholder="<?= $t['mail'] ?>" autofocus>
            <input type="password" name="password" class="form-control" placeholder="<?= $t['password'] ?>">
            <button class="btn btn-lg btn-dark w-100" type="submit" name="btnLogin"><?= $t['login2'] ?></button>
