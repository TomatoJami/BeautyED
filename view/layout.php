                ...
                <div class="collapse navbar-collapse" id="mynavbar">
                    ...
                    <ul class="navbar-nav d-flex align-items-center">
                        ...
                        if (isset($_SESSION['sessionId'])) {
                            ...
                            echo '<a href="login" class="btn btn-outline-dark me-2">Login</a>';
                            echo '<a href="register" class="btn btn btn-dark me-2">Register</a>';
                        }
                        ?>
                    </ul>
                </div>
        ...
        <div class="p-5 text-center bg-image text-white"
            ...
            <div class="d-flex justify-content-center align-items-center h-100">
                <div>
                    ...
                    <?php
                    if (isset($_SESSION['sessionId'])) {
                        echo '<a class="btn btn-outline-light btn-lg" href="appointment" role="button">Book your time</a>';
                    } else {
                        echo '<a class="btn btn-outline-light btn-lg" href="login" role="button">Book your time</a>';
                    }
                    ?>
                </div>
            </div>
